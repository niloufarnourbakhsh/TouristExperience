...
@section('main-part')
    ...
    <div>
        <h4 class="text-center mt-3 pb-3">عضویت در سامانه</h4>
        ...
        <div class="container mt-4 text-right">
            <form action="{{route('register')}}" method="POST">
                ...
                <button class="btn btn-block btn-colorful text-white text-center" type="submit" name="register">عضویت</button>
            </form>
