...
@section('image-part')
    <div class="container">
        <div class="m-auto text-center">
            <img src="{{url('storage/'.$post->photos->first()->file)}}" alt="" class="rounded first-image" id="BigImage">
        </div>
        <div class="row row-cols-3 float-left mb-3">
            @foreach($post->photos as $photo)
            <div class="col mt-2 mb-2">
                <div class="card toChoose">
                    <img src="{{url('storage/'.$photo->file)}}" alt="" class="rounded show-image-size card-img-top ">
                </div>
        ...
        <section id="comment">
            ...
            <form action="{{url('/comment/create')}}" method="POST">
                ...
                @if(!Auth::check())
                    ...
                    <textarea class="form-control bg-gray"  disabled></textarea>
                    @else

                    <textarea class="form-control my-input-style" name="body"></textarea>
                ...
                <button class="btn btn-block btn-colorful text-white text-center mt-3" type="submit">ارسال نظر</button>
            </form>
            </div>
                <div class="clr"></div>
            </div>
        ...
        <section id="show-comment" class="container m-3 mt-5">
            <div class="row top-border-purple">
                ...
                <div class="text-center col-2 mt-4 text-bold">
                    ...
                    @else
                        <button class="btn disabled" disabled="disabled"><span><i class="far fa-heart fa-2x"></i></span></button>
                    @endif
